...
<div class="site-container">
	...
	<div class="site-wrapper">
		<div class="site-page shadow-top">
			<!-- Page Title -->
			<h1 class="center-mobile">Welcome to <b><?php echo $site_subheader_1; ?></b> | Architects</h1>
			<!-- Page Title End -->
			
			<!-- Page Description -->
			<h2 class="center-mobile">An architecture &amp; design studio</h2>
			<!-- Page Description End -->
			
			<!-- Home Projects -->
			<div class="home-projects full-width">
				<!-- Title -->
				<div class="title-border right">LATEST PROJECTS</div>
				<!-- Title End -->
				
				<!-- Item List -->
				<div class="item-list" id="owl-projects">
					<!-- Item -->
						<?php 
							$proj = new Project();
							$proj->gen_projects();
